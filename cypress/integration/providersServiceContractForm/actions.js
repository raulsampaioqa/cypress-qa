...
function validarUrlHomeCadastro() {
    elements.getValidarUrlHomeCadastro()
}

function validarUrlHomeWaitApproved() {
    elements.getValidarUrlHomeWaitApproved()
}

function validarUrlHomeApproved() {
    elements.getValidarUrlHomeApproved()
}
...
export {
    ...
    validarUrlHomeCadastro,
    validarUrlHomeApproved,
    validarUrlHomeWaitApproved
}